...
public class Speed extends Module {
    ...
    public final FloatValue jumpfactorValue = new FloatValue("JumpFactor-Speed",0.02f,0.00f,5.50f);
    public final BoolValue zeroXZOnGround = new BoolValue("zeroXZOnGround",false);
    public final FloatValue motionY = new FloatValue("Motion-Y",0.42f,0.00f,10.0f);
    public final BoolValue jump = new BoolValue("Jump",false);
    public final FloatValue hypixelNegatateMotion = new FloatValue("Hypixel-Negatate-MotionY",0.003f,0.000f,100.100f);
    public final FloatValue groundBoostValue = new FloatValue("Hypixel-GroundBoost",0.11f,0.0f,10.0f);
