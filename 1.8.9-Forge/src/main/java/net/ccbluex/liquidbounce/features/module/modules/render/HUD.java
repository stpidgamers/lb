...
public class HUD extends Module {
    ...
    public void onRender2D(final Render2DEvent event) {
      ...
      //  mc.fontRendererObj.drawStringWithShadow("4.11", 100, 1, -1);
      //  mc.fontRendererObj.drawStringWithShadow("v4.11", 3f + mc.fontRendererObj.getStringWidth("Liquidbounce"), 3.5F,-1);
        //RenderUtils.drawBorderedRect(2,1,55,14,2,-1,-1);
    }
