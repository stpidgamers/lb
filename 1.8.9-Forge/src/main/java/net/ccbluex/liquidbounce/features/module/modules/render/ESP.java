...
import net.ccbluex.liquidbounce.utils.RenderUtils2;
...
public class ESP extends Module {
    ...
    public final ListValue modeValue = new ListValue("Mode", new String[]{"Box", "OtherBox", "WireFrame", "2D", "Real2D", "Outline", "ShaderOutline", "ShaderGlow","Box3"}, "Box");
